...
{
    /// <summary>
    /// Used internally to control behavior of insertion into a <see cref=" DictionaryDev{TKey, TValue}"/>.
    /// </summary>
    ...
    public class  DictionaryDev<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
    {
        ...
        public  DictionaryDev() : this(0, null) { }

        public  DictionaryDev(int capacity) : this(capacity, null) { }

        public  DictionaryDev(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

        public  DictionaryDev(int capacity, IEqualityComparer<TKey> comparer)
        {
        ...
        public  DictionaryDev(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

        public  DictionaryDev(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
            this(dictionary != null ? dictionary.Count : 0, comparer)
        {
            ...
            if (dictionary.GetType() == typeof( DictionaryDev<TKey, TValue>))
            {
                 DictionaryDev<TKey, TValue> d = ( DictionaryDev<TKey, TValue>)dictionary;
                int count = d._count;
        ...
        public  DictionaryDev(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }

        public  DictionaryDev(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer) :
        ...
        protected  DictionaryDev(SerializationInfo info, StreamingContext context)
        {
        ...
        {
            private readonly DictionaryDev<TKey, TValue> _dictionary;
            ...
            internal Enumerator( DictionaryDev<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection( DictionaryDev<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
            ...
            public struct Enumerator : IEnumerator<TKey>, IEnumerator
            {
                ...
                internal Enumerator( DictionaryDev<TKey, TValue> dictionary)
                {
                    _dictionary = dictionary;
                    _version = dictionary._version;
                    _index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection( DictionaryDev<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);

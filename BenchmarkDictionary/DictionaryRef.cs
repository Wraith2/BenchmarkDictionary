...
{
    /// <summary>
    /// Used internally to control behavior of insertion into a <see cref="DictionaryRef{TKey, TValue}"/>.
    /// </summary>
    ...
    public class DictionaryRef<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
    {
        ...
        public DictionaryRef() : this(0, null) { }

        public DictionaryRef(int capacity) : this(capacity, null) { }

        public DictionaryRef(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

        public DictionaryRef(int capacity, IEqualityComparer<TKey> comparer)
        {
        ...
        public DictionaryRef(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

        public DictionaryRef(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
            this(dictionary != null ? dictionary.Count : 0, comparer)
        {
            ...
            if (dictionary.GetType() == typeof(DictionaryRef<TKey, TValue>))
            {
                DictionaryRef<TKey, TValue> d = (DictionaryRef<TKey, TValue>)dictionary;
                int count = d._count;
        ...
        public DictionaryRef(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }

        public DictionaryRef(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer) :
        ...
        protected DictionaryRef(SerializationInfo info, StreamingContext context)
        {
        ...
        {
            private DictionaryRef<TKey, TValue> _dictionary;
            private int _version;
            private int _index;
            ...
            internal Enumerator(DictionaryRef<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(DictionaryRef<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
            ...
            public struct Enumerator : IEnumerator<TKey>, IEnumerator
            {
                ...
                internal Enumerator(DictionaryRef<TKey, TValue> dictionary)
                {
                    _dictionary = dictionary;
                    _version = dictionary._version;
                    _index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(DictionaryRef<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
            ...
            {
                private readonly DictionaryRef<TKey, TValue> _dictionary;
                private int _index;
